...
/**
 * Content for gallery_image documents
 */
interface GalleryImageDocumentData {
	/**
	 * jambsmash image field in *gallery_image*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: gallery_image.gallery_image
	 * - **Tab**: Main
	...
	/**
	 * fig caption for image field in *gallery_image*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: Enter Caption Here
	 * - **API ID Path**: gallery_image.fig_caption_for_image
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	fig_caption_for_image: prismic.KeyTextField;
}

/**
 * gallery_image document from Prismic
 *
 ...
 */
export type GalleryImageDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<GalleryImageDocumentData>, "gallery_image", Lang>;
...
interface ProjectDocumentData {
	 ...
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: this is a jambsmash project
...
export type AllDocumentTypes = GalleryImageDocument | HomepageDocument | ProjectDocument;
