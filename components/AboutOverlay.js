...
// Mock components for Navbar and Footer since they're imported
  ...
  return (
    <div 
      ...
      className={`group relative overflow-hidden bg-brand-dark/40 backdrop-blur-2xl p-8 lg:p-10 rounded-3xl border transition-all duration-700 cursor-pointer ${
        ...
        isHovered ? 'border-brand-orange/80 scale-105 shadow-2xl shadow-brand-orange/20' : 'border-brand-orange/20 hover:border-brand-orange/60 active:border-brand-orange/60'
      }`}
      style={{ 
    ...
    >
      ...
      <div className={`absolute inset-0 bg-gradient-to-br from-brand-orange/5 via-transparent to-brand-accent/5 opacity-0 transition-opacity duration-700 group-hover:opacity-100 group-active:opacity-100 ${
        isHovered ? 'opacity-100' : ''
      }`}></div>
      
      {/* Glow effect */}
      <div className={`absolute -inset-1 bg-gradient-to-r from-brand-orange/20 to-brand-accent/20 rounded-3xl blur opacity-0 transition-opacity duration-700 group-hover:opacity-100 group-active:opacity-100 ${
        isHovered ? 'opacity-100' : ''
      }`}></div>
      ...
      <div className="relative z-10">
        <div className="flex items-center mb-6">
          <div className={`p-4 rounded-2xl bg-brand-orange/10 backdrop-blur-sm border border-brand-orange/30 transition-all duration-500 mr-6 group-hover:bg-brand-orange/20 group-hover:border-brand-orange/60 group-hover:scale-110 group-active:bg-brand-orange/20 group-active:border-brand-orange/60 group-active:scale-110 ${
            isHovered ? 'bg-brand-orange/20 border-brand-orange/60 scale-110' : ''
          }`}>
            <Icon className={`w-8 h-8 transition-colors duration-500 group-hover:text-brand-orange group-active:text-brand-orange ${
              isHovered ? 'text-brand-orange' : 'text-brand-orange/80'
            }`} />
          </div>
          <h4 className={`text-2xl lg:text-3xl font-bold transition-colors duration-500 group-hover:text-brand-orange group-active:text-brand-orange ${
            isHovered ? 'text-brand-orange' : 'text-white'
          }`}>
            {title}
          </h4>
        </div>
        <p className={`text-lg lg:text-xl text-brand-light/90 leading-relaxed transition-colors duration-300 group-hover:text-brand-light group-active:text-brand-light ${
...
const DirectorCard = ({ name, qualifications, image, delay = 0 }) => {
  ...
  return (
    ...
    >
      <div className="relative transform-gpu transition-all duration-700 group-hover:rotate-y-6 group-hover:scale-105 group-active:rotate-y-6 group-active:scale-105">
        <div className="relative overflow-hidden bg-brand-dark/10 backdrop-blur-2xl p-8 lg:p-10 rounded-3xl shadow-2xl border border-brand-orange/20 group-hover:border-brand-orange/80 group-hover:shadow-brand-orange/30 group-active:border-brand-orange/80 group-active:shadow-brand-orange/30"
          ...
          <div className="relative z-10 text-center">
            <div className="relative inline-block mb-8">
              <div className="w-32 h-32 lg:w-40 lg:h-40 rounded-full bg-gradient-to-r from-brand-orange to-brand-accent p-1 group-hover:scale-110 group-active:scale-110 transition-transform duration-500">
                <img 
            ...
            <h3 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white to-brand-light bg-clip-text text-transparent mb-6 group-hover:scale-105 group-active:scale-105 transition-transform duration-300">
              {name}
            </h3>
            ...
            <div className="space-y-3">
              {qualifications.map((qualification, i) => (
                <div 
                  key={i}
                  className="inline-block bg-brand-orange/10 backdrop-blur-sm px-4 py-2 rounded-full text-brand-accent font-medium text-sm border border-brand-orange/30 group-hover:border-brand-orange/60 group-active:border-brand-orange/60 transition-colors duration-300 m-1"
                >
                  {qualification}
                </div>
              ))}
          ...
          {/* Hover glow effect */}
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-brand-orange/20 to-brand-accent/20 opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-500 blur-xl"></div>
        </div>
      </div>
    </div>
  );
...
const StatsCard = ({ number, label, icon: Icon, delay = 0 }) => {
  ...
  return (
    <div 
      ref={ref}
      className={`group text-center bg-brand-dark/10 backdrop-blur-2xl p-6 lg:p-8 rounded-2xl border border-brand-orange/20 hover:border-brand-orange/60 active:border-brand-orange/60 transition-all duration-700 hover:scale-105 active:scale-105 hover:shadow-xl active:shadow-xl hover:shadow-brand-orange/20 active:shadow-brand-orange/20 ${
        inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
      }`}
      style={{ 
        transitionDelay: `${delay}ms`,
    ...
    >
      <div className="mb-4">
        <Icon className="w-8 h-8 text-brand-orange mx-auto group-hover:scale-110 group-active:scale-110 transition-transform duration-300" />
      </div>
...
const ClientCard = ({ name, sector, logo, testimonial, delay = 0 }) => {
  ...
  return (
    <div 
      ref={ref}
      className={`group bg-brand-dark/10 backdrop-blur-2xl p-6 lg:p-8 rounded-2xl border border-brand-orange/20 hover:border-brand-orange/60 active:border-brand-orange/60 transition-all duration-700 hover:scale-105 active:scale-105 hover:shadow-xl active:shadow-xl hover:shadow-brand-orange/20 active:shadow-brand-orange/20 ${
        inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
      }`}
      style={{ 
        transitionDelay: `${delay}ms`,
    ...
    >
      <div className="flex items-center mb-4">
        ...
        <div>
          <h4 className="text-lg font-bold text-white group-hover:text-brand-orange group-active:text-brand-orange transition-colors duration-300">{name}</h4>
          <p className="text-brand-accent text-sm">{sector}</p>
        </div>
      </div>
      <p className="text-brand-light/90 italic leading-relaxed group-hover:text-brand-light group-active:text-brand-light transition-colors duration-300">
       {`"${testimonial}"`}
      </p>
...
const SustainabilityCard = ({ title, description, icon: Icon, delay = 0 }) => {
  ...
  return (
    <div 
      ref={ref}
      className={`group bg-brand-dark/10 backdrop-blur-2xl p-6 lg:p-8 rounded-2xl border border-green-500/20 hover:border-green-500/60 active:border-green-500/60 transition-all duration-700 hover:scale-105 active:scale-105 hover:shadow-xl active:shadow-xl hover:shadow-green-500/20 active:shadow-green-500/20 ${
        inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
      }`}
      style={{ 
        transitionDelay: `${delay}ms`,
    ...
    >
      <div className="mb-4">
        <Icon className="w-10 h-10 text-green-500 group-hover:scale-110 group-active:scale-110 transition-transform duration-300" />
      </div>
      <h4 className="text-xl font-bold text-white mb-3 group-hover:text-green-400 group-active:text-green-400 transition-colors duration-300">{title}</h4>
      <p className="text-brand-light/90 leading-relaxed group-hover:text-brand-light group-active:text-brand-light transition-colors duration-300">{description}</p>
    </div>
  );
};
...
const FloatingCTA = () => (
  <div className="fixed bottom-8 right-8 z-30">
    <button className="group flex items-center space-x-3 bg-gradient-to-r from-brand-orange to-brand-accent hover:from-brand-accent hover:to-brand-orange active:from-brand-accent active:to-brand-orange text-white px-6 py-4 rounded-full shadow-2xl hover:shadow-brand-orange/50 active:shadow-brand-orange/50 transform hover:scale-105 active:scale-105 transition-all duration-300">
    ...
    <div className="relative min-h-screen">
      ...
      <Section id="hero" className="text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
            <button className="group inline-flex items-center space-x-2 bg-gradient-to-r from-brand-orange to-brand-accent hover:from-brand-accent hover:to-brand-orange active:from-brand-accent active:to-brand-orange text-white px-8 py-4 rounded-full font-semibold text-lg shadow-2xl hover:shadow-brand-orange/50 active:shadow-brand-orange/50 transform hover:scale-105 active:scale-105 transition-all duration-300">
              <span>Discover Our Vision</span>
              <ArrowDown className="w-5 h-5 group-hover:translate-y-1 group-active:translate-y-1 transition-transform" />
            </button>
            <button className="group inline-flex items-center space-x-2 border-2 border-brand-orange hover:border-brand-accent active:border-brand-accent text-brand-orange hover:text-brand-accent active:text-brand-accent px-8 py-4 rounded-full font-semibold text-lg hover:bg-brand-orange/10 active:bg-brand-orange/10 transition-all duration-300">
      ...
      <Section id="vision" className="relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="group relative">
            <div className="absolute inset-0 bg-gradient-to-br from-brand-orange/20 to-brand-accent/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-500"></div>
            <div className="relative bg-brand-dark/10 backdrop-blur-2xl p-10 lg:p-12 rounded-3xl border border-brand-orange/20 hover:border-brand-orange/60 active:border-brand-orange/60 transition-all duration-500 hover:scale-105 active:scale-105"
          ...
          <div className="group relative">
            <div className="absolute inset-0 bg-gradient-to-br from-brand-accent/20 to-brand-orange/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-500"></div>
            <div className="relative bg-brand-dark/10 backdrop-blur-2xl p-10 lg:p-12 rounded-3xl border border-brand-accent/20 hover:border-brand-accent/60 active:border-brand-accent/60 transition-all duration-500 hover:scale-105 active:scale-105"
                 style={{ background: 'linear-gradient(135deg, rgba(26, 59, 68, 0.1) 0%, rgba(10, 25, 47, 0.15) 100%)' }}>
              <div className="flex items-center mb-8">
      ...
      <Section id="stats" className="relative">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <StatsCard number="50+" label="Happy Clients" icon={Users} delay={50} />
          <StatsCard number="5" label="Core Services" icon={Briefcase} delay={100} />
          <StatsCard number="4" label="Years Experience" icon={Award} delay={150} />
        </div>
      </Section>
        ...
        <div className="mt-16 bg-gradient-to-r from-green-500/10 to-emerald-500/10 backdrop-blur-2xl p-8 rounded-3xl border border-green-500/20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-brand-light/80">Waste Reduction Rate</div>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section id="leadership" className="relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
          <DirectorCard 
            ...
            image="/images/pride-mashiyani.webp"
            delay={0}
          />
          {/*<DirectorCard 
      ...
      <Section id="quality" className="relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          <div className="bg-brand-dark/10 backdrop-blur-2xl p-8 lg:p-10 rounded-3xl border border-brand-orange/20 hover:border-brand-orange/60 active:border-brand-orange/60 transition-all duration-500 hover:scale-105 active:scale-105">
            <div className="mb-6">
          ...
          <div className="bg-brand-dark/10 backdrop-blur-2xl p-8 lg:p-10 rounded-3xl border border-green-500/20 hover:border-green-500/60 active:border-green-500/60 transition-all duration-500 hover:scale-105 active:scale-105">
            <div className="mb-6">
          ...
          <div className="bg-brand-dark/10 backdrop-blur-2xl p-8 lg:p-10 rounded-3xl border border-blue-500/20 hover:border-blue-500/60 active:border-blue-500/60 transition-all duration-500 hover:scale-105 active:scale-105">
            <div className="mb-6">
      ...
      <Section className="text-center relative">
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
            <button className="group inline-flex items-center space-x-2 bg-gradient-to-r from-brand-orange to-brand-accent hover:from-brand-accent hover:to-brand-orange active:from-brand-accent active:to-brand-orange text-white px-10 py-5 rounded-full font-bold text-xl shadow-2xl hover:shadow-brand-orange/50 active:shadow-brand-orange/50 transform hover:scale-105 active:scale-105 transition-all duration-300">
              <span>Start Your Project</span>
              <ArrowRight className="w-6 h-6 group-hover:translate-x-1 group-active:translate-x-1 transition-transform" />
            </button>
            <button className="group inline-flex items-center space-x-2 border-2 border-white hover:border-brand-orange active:border-brand-orange text-white hover:text-brand-orange active:text-brand-orange px-10 py-5 rounded-full font-bold text-xl hover:bg-white/10 active:bg-white/10 transition-all duration-300">
              <span>Explore Services</span>
              <ChevronRight className="w-6 h-6 group-hover:translate-x-1 group-active:translate-x-1 transition-transform" />
            </button>
          </div>
