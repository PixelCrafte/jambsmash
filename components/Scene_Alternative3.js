...
import { useScroll, Sphere, Box, Cylinder, Torus, Text3D, Float, MeshDistortMaterial, Environment } from '@react-three/drei';
...
function CameraController() {
  ...
  useLayoutEffect(() => {
    ...
    const cameraPositions = [
      { x: 0, y: 2, z: 15, rotY: 0, rotX: -0.1 },        // Section 1: Hero - Wide view
      { x: -8, y: 4, z: 12, rotY: 0.3, rotX: -0.2 },     // Section 2: Services - Focus on circuit boards
      { x: 8, y: -2, z: 10, rotY: -0.4, rotX: 0.1 },     // Section 3: About - Solar panels view
      { x: -3, y: 6, z: 8, rotY: 0.2, rotX: -0.3 },      // Section 4: Reviews - Industrial gears
      { x: 0, y: 0, z: 18, rotY: 0, rotX: 0 },            // Section 5: Contact - Security hub focus
    ];
