...
function CameraController() {
  ...
  useLayoutEffect(() => {
    ...
    const cameraPositions = [
      ...
      { x: -8, y: 4, z: 12, rotY: 0.3, rotX: -0.2 },     // Section 2: Vision - Focus on circuit boards
      { x: 8, y: -2, z: 10, rotY: -0.4, rotX: 0.1 },     // Section 3: Services - Solar panels view
      { x: -3, y: 6, z: 8, rotY: 0.2, rotX: -0.3 },      // Section 4: Team - Industrial gears
